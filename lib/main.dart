...
const request = "https://api.hgbrasil.com/finance?format=json&key=64621ba1";
...
class _HomeState extends State<Home> {
  ...
  void _dolarChanged(String text){
    ...
    btcController.text  = (dolar * this.dolar / btc).toStringAsFixed(3);
  }
  ...
  void _euroChanged(String text){
    ...
    btcController.text   = (euro * this.euro / btc).toStringAsFixed(3);
  }
